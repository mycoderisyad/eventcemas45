...
<html lang="en">
<head>
    <title>@yield('title', 'User Dashboard') - EventCemas</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ url('/') }}" class="b-brand text-primary">
                    ...
                    <span class="badge bg-light-success rounded-pill ms-2 theme-version">User</span>
                </a>
            </div>
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('user.events') }}" class="pc-link">
                            ...
                            <span class="pc-mtext">Browse Events</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ route('user.my-events') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-ticket"></i></span>
                            <span class="pc-mtext">My Registrations</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ route('user.favorites') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-heart"></i></span>
                            <span class="pc-mtext">Favorites</span>
                        </a>
                    </li>
                ...
                <ul class="list-unstyled">
                    <li class="dropdown pc-h-item">
                        <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            @php
                                $notificationsCount = auth()->user()->registrations()
                        ...
                        <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p class="mb-0">Your registration for {{ $registration->event->name }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center py-2">
                                <a href="{{ route('user.my-events') }}" class="link-primary">View all</a>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            ...
                            <div class="tab-content" id="mysrpTabContent">
                                <div class="tab-pane fade show active" id="drp-tab-1" role="tabpanel" aria-labelledby="drp-t1" tabindex="0">
                                    ...
                                    <a href="{{ route('user.my-events') }}" class="dropdown-item">
    ...
    <footer class="pc-footer">
        <div class="footer-wrapper container-fluid">
            <div class="row">
                <div class="col my-1">
                    <p class="m-0">EventCemas &copy; {{ date('Y') }}</p>
                </div>
                <div class="col-auto my-1">
                    <ul class="list-inline footer-link mb-0">
                        <li class="list-inline-item"><a href="{{ url('/') }}">Home</a></li>
                        <li class="list-inline-item"><a href="{{ route('user.events') }}">Events</a></li>
                    </ul>
                </div>
            </div>
        </div>
